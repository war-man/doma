...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.ProjectS3in` has been altered.
...
* [#10315](http://dev.ckeditor.com/ticket/10315): [WebKit] [Undo manager](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UnProjectS3nager) should not record snapshots after a filling character was added/removed.
...
* [#10131](http://dev.ckeditor.com/ticket/10131): Fixed: [`unProjectS3nager.update()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UnProjectS3nager-method-update) does not refresh the command state.
